...
def generate_buttons():
   # Generate Buttons
    ...
    six = Button(top, text ="Start Level 6 ",fg = 'white', bg = 'purple',font=myFont ,command = problem_box_six)
    six.place(x=800,y=50) 
    seven = Button(top, text ="Start Level 7 ",fg = 'white', bg = 'red', font=myFont ,command = problem_box_seven)
    seven.place(x=50,y=150)
    eight = Button(top, text ="Start Level 8 ",fg = 'white', bg = '#ff7417',font=myFont, command = problem_box_eight)
    eight.place(x=200,y=150)
    nine = Button(top, text ="Start Level 9 ",fg = 'white',bg = '#ffcc00',font=myFont, command = problem_box_nine)
    nine.place(x=350,y=150)
    ten = Button(top, text ="Start Level 10",fg = 'white', bg = 'green',font=myFont ,command = problem_box_ten)
    ten.place(x=500,y=150)
    eleven = Button(top, text ="Start Level 11",fg = 'white', bg = 'blue',font=myFont ,command = problem_box_eleven)
    eleven.place(x=650,y=150) 
    twelve = Button(top, text ="Start Level 12",fg = 'white', bg = 'purple',font=myFont ,command = problem_box_tweleve)
